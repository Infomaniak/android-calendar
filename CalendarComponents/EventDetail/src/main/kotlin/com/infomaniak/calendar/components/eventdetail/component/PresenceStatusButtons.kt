...
private fun PresenceStatusButton.colors(): ToggleButtonColors = when (this) {
    PresenceStatusButton.Yes -> ToggleButtonDefaults.toggleButtonColors(
    ...
    PresenceStatusButton.No -> ToggleButtonDefaults.toggleButtonColors(
        checkedContainerColor = MaterialTheme.colorScheme.error,
        checkedContentColor = MaterialTheme.colorScheme.onError,
    )
    PresenceStatusButton.Maybe -> ToggleButtonDefaults.toggleButtonColors(
