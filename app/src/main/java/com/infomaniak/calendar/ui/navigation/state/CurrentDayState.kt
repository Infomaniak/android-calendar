...
class CurrentDayState(initialDate: LocalDate) {
    ...
    private val _scrollCommand = MutableSharedFlow<LocalDate>(extraBufferCapacity = 1)
    val scrollCommand: SharedFlow<LocalDate> = _scrollCommand.asSharedFlow()
